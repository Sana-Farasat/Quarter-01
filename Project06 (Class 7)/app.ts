...
//Function 
function Hello(){        //function declared
...
function Salam(){      //static function
...
function Hi(name:string){           //declare, parameter   //dynamic function
...
function abc(name , age){  //arguements will give sequence wise
...
console.log(`My eamil is ${email} ang age is ${age}`)
}
...
function sum(digit1:number , digit2:number){
