...
//we will see in this apne object ka structure

//we will make object structure through interface
...
//diameter type change krdngy tw error aega
//prperty change krdngy tw missing property ka bh error aega or incompatible ka bh
...
let tube : Tube = { //tube ka var hai ye
    diameter : 10,
    length : 8
}
...
let person = {
 ...
 person = {  //reinitialized kiya tw same property hi dengy new nh dengy
    id: 9,
    name: 'Ahmed',
}

var obj : {    //introducing index signature //jb hme properties na pta hon
    id : number ; 
    [x:string] : any ;  //any ki jga unknown bh use krskte hen but iska syntax isi trha hi hai
}={
...
//index signature means jb number of properties dyanamic ho or unke name bh dynamic ho
...
tube = ball //vice versa  //tube will give error

ball = {  //fresh object
    diameter:20,
    length:10, //length will give error
}
...
//RESOLVE hua validation hogae tw then chalega  
